      ...
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
          <div class="layui-tab-item layui-show">
            <form action="/jie/update" method="POST">
              {!! csrf_field() !!}
              {{ method_field('PATCH') }}
              ...
              <div class="layui-row layui-col-space15 layui-form-item">
                <div class="layui-col-md3">
                  ...
                  <div class="layui-input-block">
                    <select lay-verify="required" name="type_id" lay-filter="column">
              ...
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                  <textarea id="L_content" name="content" required lay-verify="required" placeholder="详细描述" class="layui-textarea fly-editor" style="height: 260px;">{{ $content }}</textarea>
                </div>
              </div>
              <!--
